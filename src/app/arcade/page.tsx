...
import { SnakesLaddersMultiplayer } from "@/components/arcade/multi-snakes-ladders"
import { FruitDuelMultiplayer } from "@/components/arcade/multi-fruit-duel"
import { LudoMultiplayer } from "@/components/arcade/multi-ludo"
    ...
    <div className="flex flex-col p-3 md:p-5 space-y-4 max-w-7xl mx-auto pb-20 overflow-x-hidden">
            ...
            {onlineUsers.map(u => (
              <div key={u.id} className="flex flex-col items-center gap-1 min-w-[80px]">
                ...
                >
                  ...
                  <option value="multi_snakes">Snakes & Ladders</option>
                  <option value="multi_duel">Fruit Duel</option>
                  <option value="multi_ludo">Ludo</option>
                </select>
              </div>
            ))}
          </CardContent>
            ...
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-sm font-bold uppercase tracking-widest">
                {incomingChallenge.challengerName} challenged you to {
                  ...
                  incomingChallenge.game === 'multi_snakes' ? 'Snakes & Ladders' :
                  incomingChallenge.game === 'multi_duel' ? 'Fruit Duel' :
                  incomingChallenge.game === 'multi_ludo' ? 'Ludo' :
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="bg-transparent w-full flex flex-wrap h-auto mb-4 justify-center gap-2">
          ...
          <TabsTrigger value="multi_snakes" className="rounded-xl font-bold py-2 px-4 gap-2 shrink-0 data-[state=active]:shadow-lg bg-white/50 data-[state=active]:bg-white"><Gamepad2 className="h-4 w-4 text-emerald-500" /> Snakes <Badge className="bg-primary text-white ml-1 text-[9px] h-4 px-1 hidden md:flex">PVP</Badge></TabsTrigger>
          <TabsTrigger value="multi_duel" className="rounded-xl font-bold py-2 px-4 gap-2 shrink-0 data-[state=active]:shadow-lg bg-white/50 data-[state=active]:bg-white"><Zap className="h-4 w-4 text-amber-500" /> Fruit Duel <Badge className="bg-primary text-white ml-1 text-[9px] h-4 px-1 hidden md:flex">PVP</Badge></TabsTrigger>
          <TabsTrigger value="multi_ludo" className="rounded-xl font-bold py-2 px-4 gap-2 shrink-0 data-[state=active]:shadow-lg bg-white/50 data-[state=active]:bg-white"><Activity className="h-4 w-4 text-purple-500" /> Ludo <Badge className="bg-primary text-white ml-1 text-[9px] h-4 px-1 hidden md:flex">PVP</Badge></TabsTrigger>
        ...
        <div className="mt-4 flex flex-col items-center justify-center">
          ...
          <TabsContent value="multi_snakes"><Card className="rounded-[2.5rem] md:rounded-[3rem] bg-white shadow-xl overflow-hidden border-0 w-[95vw] max-w-md sm:min-w-[400px] mx-auto"><SnakesLaddersMultiplayer matchId={activeMatch?.game === "multi_snakes" ? activeMatch.id : undefined} role={activeMatch?.role as "X" | "O"} opponentName={activeMatch?.opponentName} onLeave={() => setActiveMatch(null)} /></Card></TabsContent>
          <TabsContent value="multi_duel"><Card className="rounded-[2.5rem] md:rounded-[3rem] bg-white shadow-xl overflow-hidden border-0 w-[95vw] max-w-md sm:min-w-[400px] mx-auto"><FruitDuelMultiplayer matchId={activeMatch?.game === "multi_duel" ? activeMatch.id : undefined} role={activeMatch?.role as "X" | "O"} opponentName={activeMatch?.opponentName} onLeave={() => setActiveMatch(null)} /></Card></TabsContent>
          <TabsContent value="multi_ludo"><Card className="rounded-[2.5rem] md:rounded-[3rem] bg-white shadow-xl overflow-hidden border-0 w-[95vw] max-w-md sm:min-w-[400px] mx-auto"><LudoMultiplayer matchId={activeMatch?.game === "multi_ludo" ? activeMatch.id : undefined} role={activeMatch?.role as "X" | "O"} opponentName={activeMatch?.opponentName} onLeave={() => setActiveMatch(null)} /></Card></TabsContent>
          ...
          <TabsContent value="multi_guess"><Card className="rounded-[2.5rem] md:rounded-[3rem] bg-white shadow-xl overflow-hidden border-0 w-[95vw] max-w-md sm:min-w-[400px] mx-auto"><NumberGuessMultiplayer matchId={activeMatch?.game === "multi_guess" ? activeMatch.id : undefined} role={activeMatch?.role as "X" | "O"} opponentName={activeMatch?.opponentName} onLeave={() => setActiveMatch(null)} /></Card></TabsContent>
          <TabsContent value="multi_word"><Card className="rounded-[2.5rem] md:rounded-[3rem] bg-white shadow-xl overflow-hidden border-0 w-[95vw] max-w-md sm:min-w-[400px] mx-auto"><WordRaceMultiplayer matchId={activeMatch?.game === "multi_word" ? activeMatch.id : undefined} role={activeMatch?.role as "X" | "O"} opponentName={activeMatch?.opponentName} onLeave={() => setActiveMatch(null)} /></Card></TabsContent>
        </div>
      </Tabs>
    </div>
  )
